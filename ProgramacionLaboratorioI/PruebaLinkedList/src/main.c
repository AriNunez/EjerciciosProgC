...
int main()
{
    ...
    LinkedList* ClonelistaEmpleados;
    LinkedList* SublistaEmpleados;
    Employee* pEmpleadoPop;
    int flagAlta;
    	...
    	if(utn_getInt(&option, "\nIngrese una opcion: \n", "\n¡ERROR!\n", 1, 16, 3)==0)
    	    {
				switch(option)
				{
					...
					case 10:
						...
						break;
					case 11:
						ClonelistaEmpleados = ll_clone(listaEmpleados);
						controller_ListEmployee(ClonelistaEmpleados);
					...
					case 12:
						...
						break;
					case 13:
						SublistaEmpleados = ll_subList(listaEmpleados, 0, 100);
					...
					case 14:
						...
						break;
					case 15:
						if(ll_containsAll(listaEmpleados, SublistaEmpleados)==1)
						{
							puts("\nLA LISTA DOS ESTA CONTENIDA EN LA UNO\n");
						}
						else
						{
							puts("\nLA LISTA DOS NO ESTA CONTENIDA EN LA UNO\n");
						}
						break;
					case 16:
						pEmpleadoPop = ll_pop(SublistaEmpleados, 5);
						employee_MostrarUno(pEmpleadoPop);
						break;
